...
from ..utils.analytics import get_sbom_count, log_sbom_generation
        ...
        try:
            ...
            if parsed.netloc == "huggingface.co":
                ...
                if len(parts) >= 2 and parts[0] and parts[1]:
                    if re.match(r"^[a-zA-Z0-9\.\-\_]+$", parts[0]) and re.match(r"^[a-zA-Z0-9\.\-\_]+$", parts[1]):
                        return True
            return False
        except Exception:
            return False
...
async def root(request: Request):
    return templates.TemplateResponse("index.html", {"request": request, "sbom_count": get_sbom_count()})
