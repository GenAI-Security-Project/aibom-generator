...
def main():
    ...
    parser.add_argument(
        ...
        "-t",
        action="store_true",
        help="Run test mode for multiple predefined models to verify description generation",
    )
    ...
    parser.add_argument(
        ...
        "-i",
        action="store_true",
        help="Use AI inference for enhanced metadata (requires configured valid endpoint)",
    )
    parser.add_argument(
        "--summarize",
        "-s",
        action="store_true",
        help="Enable intelligent description summarization (requires model download)",
    )
